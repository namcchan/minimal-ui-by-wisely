...
const wrapFourOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const TourListFiltersPage: React.FC = () => {
  ...
  const sideBarMenu1: SideBarMenuType = [
    {
      ...
      label: <Text className="font-semibold text-blue_gray-900">List</Text>,
      href: "/productlist",
...
export default TourListFiltersPage;
