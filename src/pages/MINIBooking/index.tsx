...
const MINIBookingPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-start mx-auto w-full">
        <MINIAppRowlogo className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full" />
      </div>
    </>
  );
};

export default MINIBookingPage;
