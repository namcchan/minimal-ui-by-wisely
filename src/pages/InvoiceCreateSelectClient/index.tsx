...
const wrapTwoOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const InvoiceCreateSelectClientPage: React.FC = () => {
  ...
  const sideBarMenu1: SideBarMenuType = [
    ...
    },
    {
      ...
      label: <Text className="mt-1.5">Chat</Text>,
      href: "/chat",
    ...
    },
    {
      ...
      label: <Text className="mt-1.5">Calendar</Text>,
      href: "/calendar",
    ...
    },
    {
      ...
      label: <Text className="mt-1.5">Kanban</Text>,
      href: "/kanban",
      active: window.location.pathname === "/kanban",
    },
  ];
  const [wrapfourvalue, setWrapfourvalue] = React.useState<string>("");

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-end mx-auto w-full">
        <AppRowlogo
          className="bg-white-A700 h-[1600px] md:h-[3922px] md:px-5 relative w-full"
          call="images/img_call_teal_500.svg"
          arrowrightThree="images/img_arrowdown_teal_500_16x16.svg"
...
export default InvoiceCreateSelectClientPage;
