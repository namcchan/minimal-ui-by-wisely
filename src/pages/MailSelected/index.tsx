...
const attachmentCounterOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const MailSelectedPage: React.FC = () => {
  ...
  const sideBarMenu1: SideBarMenuType = [
    ...
    {
      icon: (
        <Img className="h-6 w-6" src="images/img_bag_teal_500.svg" alt="bag" />
      ),
      label: (
        <>
          <Text>Mail</Text>
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-end mx-auto w-full">
        <AppRowlogo
          ...
          bag="images/img_bag_teal_500.svg"
          p32="32+"
          label="Free"
          badge="1"
        />
...
export default MailSelectedPage;
