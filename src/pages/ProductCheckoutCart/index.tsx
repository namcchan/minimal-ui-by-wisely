...
import ProductCheckoutCartTablecart from "components/ProductCheckoutCartTablecart";

const ProductCheckoutCartPage: React.FC = () => {
  return (
    <>
        ...
        <div className="flex flex-col gap-10 items-start justify-start max-w-[1440px] pb-20 pt-10 md:px-10 px-36 sm:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-6 items-start justify-start w-auto md:w-full">
            <div className="flex flex-col gap-6 items-start justify-start w-auto md:w-full">
              <ProductCheckoutCartTablecart className="bg-white-A700 flex flex-col items-start justify-start max-w-[712px] rounded-[16px] shadow-bs4 w-full" />
...
export default ProductCheckoutCartPage;
