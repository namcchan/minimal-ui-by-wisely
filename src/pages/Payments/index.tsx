...
const PaymentsPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans gap-10 items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        <Header
        ...
        />
        <div className="flex flex-col gap-10 h-full items-center justify-start md:px-10 px-36 sm:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-6 items-start justify-start max-w-6xl mx-auto w-full">
            <div className="border border-blue_gray-300_28 border-dashed flex flex-1 md:flex-col flex-row gap-10 items-start justify-start max-w-[760px] p-10 sm:px-5 rounded-[16px] w-full">
              <PaymentsPricingpayment className="bg-white-A700 flex flex-1 flex-col gap-10 items-start justify-start w-full" />
              <PaymentsPricingpayment1 className="bg-white-A700 flex flex-1 flex-col gap-10 items-start justify-start w-full" />
            </div>
            <PaymentsPricingpayment2 className="bg-gray-100 flex flex-1 flex-col items-center justify-start p-10 sm:px-5 rounded-[16px] w-full" />
          </div>
        </div>
      </div>
    </>
