...
const ChatDetailsGroupUserInfoPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-end mx-auto w-full">
        <AppRowlogo
          className="bg-white-A700 h-[1600px] md:h-[4462px] md:px-5 relative w-full"
...
export default ChatDetailsGroupUserInfoPage;
