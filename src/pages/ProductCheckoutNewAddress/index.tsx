...
import ProductCheckoutNewAddressColumntitleTwo from "components/ProductCheckoutNewAddressColumntitleTwo";
...
const ProductCheckoutNewAddressPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-publicsans mx-auto relative w-[1440px] sm:w-full md:w-full">
        <div className="flex flex-col items-center justify-end m-auto w-full">
        ...
        <ProductCheckoutNewAddressColumntitleTwo
          className="absolute bg-cover bg-no-repeat flex flex-col h-full inset-[0] items-center justify-center m-auto p-[212px] md:px-10 sm:px-5 rounded-[24px] w-full"
          style={{
...
export default ProductCheckoutNewAddressPage;
