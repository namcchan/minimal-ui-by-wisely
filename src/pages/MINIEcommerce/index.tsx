...
const MINIEcommercePage: React.FC = () => {
  ...
  const sideBarMenu: SideBarMenuType = [
    {
      icon: (
        <Img
          ...
          src="images/img_icon_teal_500_24x24.svg"
          alt="iconsduotoneice"
        />
      ),
      label: <></>,
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-start mx-auto w-full">
        <MINIAppRowlogo
          ...
          iconsduotoneice="images/img_icon_teal_500_24x24.svg"
...
export default MINIEcommercePage;
