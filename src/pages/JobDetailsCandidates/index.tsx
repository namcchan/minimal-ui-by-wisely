...
const JobDetailsCandidatesPage: React.FC = () => {
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-publicsans items-center justify-end mx-auto w-full">
        <AppRowlogo
          ...
          iconSix="images/img_icon_12.svg"
          arrowrightFive="images/img_arrowdown_teal_500_16x16.svg"
...
export default JobDetailsCandidatesPage;
