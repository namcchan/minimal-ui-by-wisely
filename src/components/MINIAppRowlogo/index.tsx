...
> &
  Partial<{
    dashboard: string;
    title: string;
    iconsduotoneice: string;
    titleOne: string;
    iconsduotoneica: string;
    titleTwo: string;
    iconsduotoneicb: string;
    titleThree: string;
    iconsduotoneicbOne: string;
    titleFour: string;
    iconsduotoneicf: string;
    titleFive: string;
    titleSix: string;
    titleSeven: string;
    titleEight: string;
...
const MINIAppRowlogo: React.FC<MINIAppRowlogoProps> = (props) => {
    ...
    <>
      <div className={props.className}>
        <Sidebar
          ...
          className="!sticky !w-[88px] bg-white-A700 border-blue_gray-300_33 border-dashed border-r flex h-screen md:hidden justify-start overflow-auto top-[0]"
        >
          <div className="flex flex-col items-center justify-center mb-[2428px] py-4 w-[88px]">
            <Img
          ...
          <Img
            className="h-[22px] mb-[2398px] mt-20 mx-auto w-[22px]"
            alt="dashboard"
            src={props?.dashboard}
          />
          <Menu
            ...
            className="flex flex-col items-center justify-end mb-[1414px] mt-[88px] pt-[21px] px-1.5 w-[87%]"
          >
            <div className="flex flex-col gap-4 items-center justify-start w-full">
              <Text
                className="text-[10px] text-blue_gray-500 text-center w-full"
                size="txtPublicSansMedium10"
              >
                {props?.title}
              </Text>
              <div className="flex flex-col gap-[-4.14px] items-center justify-end w-full">
            ...
            <div className="flex flex-row items-end justify-start mt-[9px] w-full">
              <Img
                className="h-[22px] mt-2 w-[76px]"
                src="images/img_user_blue_gray_500.svg"
                alt="user"
              />
              <div className="flex flex-col items-center justify-center mb-[3px] pr-1.5 pt-[11px] w-auto">
                <Img
                  className="h-4 w-[76px]"
                  src="images/img_arrowright_blue_gray_500_16x16.svg"
                  alt="arrowright"
                />
              </div>
            </div>
            <Text
              className="mt-1.5 text-[10px] text-blue_gray-500 text-center w-full"
              size="txtPublicSansMedium10"
            >
              {props?.titleSix}
            </Text>
            ...
            <Text
              className="mt-[7px] text-[10px] text-blue_gray-500 text-center w-full"
              size="txtPublicSansMedium10"
            >
              {props?.titleTen}
            </Text>
            <div className="flex flex-row items-end justify-start mt-2 w-full">
              <Img
                className="h-[22px] mt-2 w-[76px]"
            ...
            <div className="flex flex-col gap-[17px] items-center justify-end mt-1.5 w-full">
              <Text
                className="text-[10px] text-blue_gray-500 text-center w-full"
                size="txtPublicSansMedium10"
              >
              ...
              <div className="flex flex-col gap-[-46.67px] items-center justify-end w-full">
        ...
        <div className="flex-1 h-[2426px] sm:h-[3730px] md:h-[7306px] pb-[88px] relative w-full">
          <div
            className="absolute bg-cover bg-no-repeat bg-white-A700 flex flex-col h-20 md:h-auto inset-x-[0] items-center justify-between max-w-[1352px] mx-auto px-10 sm:px-5 top-[0] w-full"
          ...
          <div className="absolute flex flex-col gap-6 h-max inset-[0] items-center justify-start m-auto max-w-[1272px] px-10 sm:px-5 py-[88px] w-full">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-start w-full">
              <div className="flex flex-1 flex-col gap-6 items-start justify-start w-full">
                <div className="flex md:flex-col flex-row gap-6 items-start justify-start w-full">
                  <div className="bg-white-A700 p-6 sm:px-5 relative rounded-[16px] w-full">
                    ...
                    <div className="flex flex-col gap-6 items-center justify-start m-auto relative w-[89%] md:w-full">
                ...
                <div className="bg-white-A700 flex flex-col items-center justify-start rounded-[16px] shadow-bs4 w-full">
                  <div className="flex md:flex-col flex-row gap-4 items-start justify-start sm:pl-5 pl-6 pr-4 py-6 w-full">
                    ...
                    {!!props?.action ? (
                      <SelectBox
                        className="!text-blue_gray-900 md:flex-1 font-publicsans font-semibold text-left text-sm w-[9%] md:w-full"
                      ...
                      <div className="flex flex-1 flex-col gap-3 items-start justify-center w-full">
                        <div className="flex flex-col gap-[42px] items-start justify-start w-full">
                          ...
                          <div className="relative w-full">
                            ...
                            {!!props?.chartcolumn ? (
                              <Img
                                className="absolute h-[200px] inset-x-[0] mx-auto top-[0] w-[726px]"
                                alt="chartcolumn"
              ...
              <div className="flex sm:flex-1 flex-col gap-6 items-start justify-start w-[408px] sm:w-full">
            ...
            <div className="flex flex-col gap-6 items-start justify-start py-4 w-full">
              ...
              >
                <div className="bg-gray-100 flex flex-1 flex-col items-start justify-start rounded-[16px] w-full">
                  ...
                  <div className="p-2 relative w-[300px]">
                    <div className="bg-orange-50 flex flex-1 flex-col items-center justify-start m-auto rounded-[12px] w-[284px]">
                      {!!props?.imgtravelmfive ? (
                        <Img
                          className="h-[284px] md:h-auto object-cover rounded-[12px] w-[284px]"
                          alt="imgtravelmFive"
            ...
            <div className="bg-white-A700 flex flex-col items-start justify-start rounded-[16px] shadow-bs4 w-full">
              ...
              <div className="flex flex-col items-end justify-start p-4 w-full">
                <div className="flex flex-row gap-2 h-[30px] md:h-auto items-center justify-center px-1 rounded-lg w-auto">
                  ...
                  {!!props?.arrowrightNine ? (
                    <Img
                      className="h-[18px] w-[18px]"
                      alt="arrowright_Nine"
                      src={props?.arrowrightNine}
                    />
                  ) : null}
                </div>
              </div>
...
MINIAppRowlogo.defaultProps = {
  dashboard: "images/img_dashboard_blue_gray_500.svg",
  title: "App",
  iconsduotoneice: "images/img_iconsduotoneicecommerce.svg",
  titleOne: "E-commerce",
  iconsduotoneica: "images/img_iconsduotoneicanalytics.svg",
  titleTwo: "Analytics",
  iconsduotoneicb: "images/img_icon_blue_gray_500_24x24.svg",
  titleThree: "Banking",
  iconsduotoneicbOne: "images/img_icon_8.svg",
  titleFour: "Booking",
  iconsduotoneicf: "images/img_icon_1.svg",
  titleFive: "File",
  titleSix: "User",
  titleSeven: "Product",
  titleEight: "Order",
